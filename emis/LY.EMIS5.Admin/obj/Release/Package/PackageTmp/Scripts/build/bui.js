...
define('bui/json',['bui/ua'],function (require) {
  ...
  var cx = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
    ...
    function str(key, holder) {
      ...
      // Produce a string from holderDataKey.
    ...
    */
    ...
    PositionView.prototype = {
        ...
        _uiSetX:function (x) {
            if (x != null) {
                this.get('el').offset({
                    left: ($(window).width()/2)-(this.get('el').width()/2)
                });
            }
        },
        _uiSetY: function (y) {
            //alert((document.documentElement.clientHeight / 2 - this.get('el').height() / 2));
            if (y != null) {
                this.get('el').offset({
                    top: 80
                });
...
define('bui/calendar/monthpicker',['bui/common','bui/overlay','bui/list','bui/toolbar'],function (require){
  ...
  var MonthPanel = List.extend({
    ...
    ATTRS:{
      itemTpl:{
        view:true,
        value : '<li class="'+CLS_ITEM+' x-monthpicker-month"><a hidefocus="on">{text}</a></li>'
      },
  ...
  var YearPanel = List.extend({
    ...
    ATTRS:{
      ...
      itemTpl : {
        view:true,
        value : '<li class="'+CLS_ITEM+' '+CLS_YEAR+'"><a hidefocus="on">{text}</a></li>'
      },
      tpl : {
        view:true,
