...
(function ($) {
    ...
    $.fn.birthdaypicker = function (options) {
        ...
        return this.each(function () {
            ...
            var $wraper = $(_wrap),
                $year = $("<select class='birth-year' name='birth[year]' style='width:70px;'></select>"),
                $month = $("<select class='birth-month' name='birth[month]' style='width:60px;'></select>"),
                $day = $("<select class='birth-day' name='birth[day]' style='width:60px;'></select>");
            ...
            if (settings["defaultDate"]) {
                var date = settings["defaultDate"].toString().split("-");
            ...
            $wraper.change(function () {
                ...
                if ((selectedYear * selectedMonth * selectedDay) != 0) {
                    ...
                    $('input[name="' + settings["fieldName"] + '"]').remove();
