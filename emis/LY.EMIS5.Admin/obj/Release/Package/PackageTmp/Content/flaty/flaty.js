$(function () {
    ...
    var r = ["blue", "red", "green", "orange", "yellow", "pink", "magenta", "gray", "black"];
    $.each(r,
    function (e, t) {
    ...
    $(".box .box-tool > a").click(function (e) {
        ...
        switch (t) {
            case "collapse":
                ...
                $(this).parents(".box").children(".box-content").slideToggle(500,
                function () {
                    if ($(this).is(":hidden")) {
    ...
    if (jQuery().fullCalendar) {
        ...
        $("#event_priority_chzn").click(N);
        T("My Event 1", "default");
        T("My Event 2", "success");
        T("My Event 3", "info");
        T("My Event 4", "warning");
        T("My Event 5", "important");
        T("My Event 6", "success");
        T("My Event 7", "info");
        T("My Event 8", "warning");
        T("My Event 9", "success");
        T("My Event 10", "default");
        $("#calendar").fullCalendar({
            ...
            events: [{
                title: "All Day Event",
                start: new Date(E, w, 1),
                className: "label label-default"
            },
            {
                title: "Long Event",
                start: new Date(E, w, b - 5),
                end: new Date(E, w, b - 2),
                className: "label label-success"
            },
            {
                id: 999,
                title: "Repeating Event",
                start: new Date(E, w, b - 3, 16, 0),
                allDay: false,
                className: "label label-default"
            },
            {
                id: 999,
                title: "Repeating Event",
                start: new Date(E, w, b + 4, 16, 0),
                allDay: false,
                className: "label label-important"
            },
            {
                title: "Meeting",
                start: new Date(E, w, b, 10, 30),
                allDay: false,
                className: "label label-info"
            },
            {
                title: "Lunch",
                start: new Date(E, w, b, 12, 0),
                end: new Date(E, w, b, 14, 0),
                allDay: false,
                className: "label label-warning"
            },
            {
                title: "Birthday Party",
                start: new Date(E, w, b + 1, 19, 0),
                end: new Date(E, w, b + 1, 22, 30),
                allDay: false,
                className: "label label-success"
            },
            {
                title: "Click for Google",
                start: new Date(E, w, 28),
                end: new Date(E, w, 29),
                url: "http://google.com/",
                className: "label label-warning"
            }]
    ...
    if (jQuery.plot) {
        var C = $("#visitors-chart");
        if ($(C).size() == 0) {
            return
        }
        var k = [[1, 35], [2, 48], [3, 34], [4, 54], [5, 46], [6, 37], [7, 40], [8, 55], [9, 43], [10, 61], [11, 52], [12, 57], [13, 64], [14, 56], [15, 48], [16, 53], [17, 50], [18, 59], [19, 66], [20, 73], [21, 81], [22, 75], [23, 86], [24, 77], [25, 86], [26, 85], [27, 79], [28, 83], [29, 95], [30, 92]];
        var L = [[1, 9], [2, 15], [3, 16], [4, 21], [5, 19], [6, 15], [7, 22], [8, 29], [9, 20], [10, 27], [11, 32], [12, 37], [13, 34], [14, 30], [15, 28], [16, 23], [17, 28], [18, 35], [19, 31], [20, 28], [21, 33], [22, 25], [23, 27], [24, 24], [25, 36], [26, 25], [27, 39], [28, 28], [29, 35], [30, 42]];
